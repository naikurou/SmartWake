...
<head>
  ...
  <link rel="stylesheet" href="/smartwake/assets/css/style.css?v=<?= time() ?>">
</head>
<body>
<script>
  (function () {
  ...
  <nav class="navbar" role="navigation" aria-label="Navigation principale">
    <div class="container navbar-inner">
      ...
      <ul class="navbar-nav" id="navbar-nav" role="list">
        ...
        <li>
          <button id="theme-toggle" class="theme-toggle-btn" style="background:none; border:none; cursor:pointer; font-size:1.25rem; display:flex; align-items:center; justify-content:center; padding:0.5rem; color:var(--text-muted); transition:color 0.3s;" aria-label="Changer de thème">☀️</button>
        </li>
        <li>
      ...
      <article class="card metric-card reveal" aria-label="Informations capteur">
        ...
        <div class="sensor-info">
          ...
          <div class="sensor-info-row">
            ...
            <span class="sensor-info-val">COM14 · 9600 baud</span>
          </div>
          <div class="sensor-info-row">
...
<script src="/smartwake/assets/js/app.js?v=<?= time() ?>" defer></script>
<script>
      ...
      btn.addEventListener('click', () => {
        ...
        if (typeof Chart !== 'undefined' && Chart.instances) {
          Object.values(Chart.instances).forEach(chart => {
            const gridColor = isLight ? 'rgba(0, 0, 0, 0.08)' : 'rgba(59, 130, 246, 0.1)';
            const textColor = isLight ? 'rgba(36, 36, 36, 0.8)' : 'rgba(148, 163, 184, 0.9)';
            const fillColor = isLight ? 'rgba(0, 164, 239, 0.05)' : 'rgba(37, 99, 235, 0.15)';
